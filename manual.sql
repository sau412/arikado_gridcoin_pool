...
CREATE TABLE `boincmgr_hosts` (
  ...
  `n_usable_coprocs` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `boincmgr_projects` (`uid`, `name`, `project_url`, `url_signature`, `status`, `passwd_hash`, `weak_auth`) VALUES
...
(5, 'DrugDiscovery@Home', 'https://boinc.drugdiscoveryathome.com/', '\n.', 'whitelisted', '', ''),
...
CREATE TABLE `boincmgr_project_host_stats` (
  ...
  `billing_period_uid` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
ALTER TABLE `boincmgr_hosts`
  ADD PRIMARY KEY (`uid`),
  ADD UNIQUE KEY `internal_host_cpid` (`internal_host_cpid`) USING BTREE,
  ADD UNIQUE KEY `external_host_cpid` (`external_host_cpid`) USING BTREE,
  ADD KEY `username` (`username`);

ALTER TABLE `boincmgr_host_projects`
  ADD PRIMARY KEY (`uid`),
  ADD UNIQUE KEY `host_id` (`host_id`,`host_cpid`),
  ADD UNIQUE KEY `project_name` (`project_name`,`host_id`);
...
ALTER TABLE `boincmgr_project_hosts_last`
  ADD PRIMARY KEY (`uid`),
  ADD UNIQUE KEY `project_uid` (`project_uid`,`host_id`);
