...
ON DUPLICATE KEY UPDATE `result_name`=VALUES(`result_name`),`status`=VALUES(`status`),`elapsed_time`=VALUES(`elapsed_time`),`cpu_time`=VALUES(`cpu_time`),`score`=VALUES(`score`),`timestamp`=NOW()");
